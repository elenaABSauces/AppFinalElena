...
CREATE TABLE IF NOT EXISTS DAW216DBDepartamentos.T02_Departamento(
...
CREATE TABLE IF NOT EXISTS DAW216DBDepartamentos.T01_Usuario(
...
GRANT ALL PRIVILEGES ON DAW216DBDepartamentos.* TO 'usuarioDAW216DBProyectoFinal'@'%';
