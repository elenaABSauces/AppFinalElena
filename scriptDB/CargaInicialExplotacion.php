...
EOD;
                ...
                echo "<h3> <span style='color: green;'>"."Valores insertados</span></h3>";//Si no se ha producido ningún error nos mostrará "Conexion establecida con exito"
            }
                ...
                echo "<span style='color: red;'>Codigo del error: </span>".$errorExcepcion;//Mostramos el código de la excepción
            } finally {
                unset($miDB);
            }
?>